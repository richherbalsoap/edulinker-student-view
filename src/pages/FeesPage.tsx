  ...
  return (
    <div className="space-y-6 relative z-10 px-4 py-6">
      ...
      {showQrModal && paymentQr && (
        ...
        >
          <div
            className="bg-black/95 backdrop-blur-2xl border border-primary/30 rounded-2xl p-6 max-w-xs w-full"
          ...
          >
            ...
            <p className="text-foreground/40 text-xs mb-4 text-center">
              GPay / PhonePe / BHIM — kisi bhi UPI app se scan karo
            </p>
            ...
            <p className="text-foreground/20 text-xs text-center mt-4">
              Bahar tap karo ya × press karo band karne ke liye
            </p>
          </div>
        </div>
      )}
